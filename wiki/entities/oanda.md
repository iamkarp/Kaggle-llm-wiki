...
**Outgoing:**
- _related_to_ → [[concepts/straddle-strategy|Straddle Strategy]]
- _related_to_ → [[strategies/nfp-straddle-forex|NFP Straddle — Forex Volatility Strategy on Non-Farm Payroll]]

**Incoming:**
- [[concepts/straddle-strategy|Straddle Strategy]] _uses_ → here
- [[strategies/nfp-straddle-forex|NFP Straddle — Forex Volatility Strategy on Non-Farm Payroll]] _uses_ → here
- [[comparisons/nfp-stop-configurations|NFP Stop Configurations Comparison]] _works_with_ → here
