---
id: pattern:oof-vs-lb-divergence
type: pattern
title: OOF vs LB Divergence
slug: oof-vs-lb-divergence
aliases: []
tags:
- validation
- leakage
...
- _related_to_ → [[patterns/cross-subject-generalization|Cross-Subject Generalization]]

**Incoming:**
- [[techniques/threshold-optimization|Per-Class Threshold Optimization]] _improves_on_ → here
