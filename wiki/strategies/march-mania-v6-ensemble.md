---
id: strategy:march-mania-v6-ensemble
type: strategy
title: March Mania v6 Ensemble — Weighted 3-Pipeline Architecture
slug: march-mania-v6-ensemble
aliases: []
tags:
- ensemble
- xgboost
...
- _uses_ → [[concepts/calibration|Probability Calibration — Platt Scaling and Isotonic Regression]]
...
- _requires_ → [[concepts/xgboost-ensembles|XGBoost Ensembles — Weighted Averaging of Gradient Boosted Trees]]
