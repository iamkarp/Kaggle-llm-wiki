---
id: strategy:kaggle-competition-playbook
type: strategy
...
- _requires_ → [[concepts/feature-engineering-tabular|Feature Engineering — Tabular Data Patterns]]
- _requires_ → [[concepts/target-encoding|Target Encoding — Weighted Blend with OOF]]
- _requires_ → [[concepts/text-feature-engineering|Text Feature Engineering — Embeddings vs TF-IDF vs Regex Extraction]]
