---
id: competition:santa-2024-pancake
type: competition
title: Santa 2024 — Pancake Sorting
slug: santa-2024-pancake
aliases: []
tags:
...
**Outgoing:**
- _uses_ → [[techniques/beam-search|Beam Search for Combinatorial Optimization]]
- _uses_ → [[techniques/inverse-problem-solving|Inverse Problem Solving]]
- _caused_ → [[mistakes/nmcs-large-search-spaces|NMCS for Large Search Spaces]]
- _instance_of_ → `task_type:combinatorial-optimization` (Combinatorial Optimization)

**Incoming:**
- [[patterns/c-vs-python-compute|C vs Python for Compute-Intensive Search]] _applied_in_ → here
- [[techniques/beam-search|Beam Search for Combinatorial Optimization]] _applied_in_ → here
- [[techniques/inverse-problem-solving|Inverse Problem Solving]] _succeeded_in_ → here
- [[techniques/inverse-problem-solving|Inverse Problem Solving]] _applied_in_ → here
- [[mistakes/nmcs-large-search-spaces|NMCS for Large Search Spaces]] _failed_in_ → here
- [[patterns/c-vs-python-compute|C vs Python for Compute-Intensive Search]] _failed_in_ → here
