---
id: competition:horse-health-prediction
type: competition
title: Horse Health Prediction (Kaggle Playground)
slug: horse-health-prediction
aliases: []
tags:
- kaggle
- tabular
...
**Outgoing:**
- _uses_ → [[competitions/horse-health-prediction|UCI Horse Colic]]
- _uses_ → [[competitions/horse-health-prediction|Hospital target encoding]]
- _uses_ → [[competitions/horse-health-prediction|Lesion decomposition]]
- _uses_ → [[competitions/horse-health-prediction|Seed averaging]]
...
- _evaluated_by_ → `metric:micro-f1` (Micro F1)
- _hosted_by_ → `organization:kaggle` (Kaggle)
- _instance_of_ → `task_type:multiclass-classification` (Multiclass Classification)
- _cites_ → `source:kaggle-competition-playbook` (Kaggle Competition Playbook)
- _cites_ → `source:target-encoding-advanced` (Advanced Target Encoding Techniques for Kaggle)
...
- [[competitions/horse-health-prediction|Horse Health Prediction (Kaggle Playground) — v1 blend]] _part_of_ → here
- [[competitions/horse-health-prediction|Horse Health Prediction (Kaggle Playground) — v2 blend]] _part_of_ → here
