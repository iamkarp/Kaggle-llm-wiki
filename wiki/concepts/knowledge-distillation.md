---
id: concept:knowledge-distillation
type: concept
title: Knowledge Distillation — LGBM→NN Soft Labels, Cosine Schedules, Cross-Model
  Transfer
...
**Incoming:**
- [[concepts/kaggle-landscape-2024-2026|Kaggle Competitive Landscape 2024-2026]] _uses_ → here
- [[concepts/synthetic-data-distillation|Synthetic Data Distillation — Teacher→Student for Kaggle]] _uses_ → here
...
- [[concepts/tabpfn-tabm|TabPFN & TabM — New SOTA Tabular Foundation Models]] _related_to_ → here
