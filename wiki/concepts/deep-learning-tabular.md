---
id: concept:deep-learning-tabular
type: concept
title: Deep Learning on Tabular Data — When DNNs Beat GBMs
slug: deep-learning-tabular
aliases: []
tags:
- deep-learning
- tabular
...
**Outgoing:**
- _cites_ → `source:icr-age-conditions-1st-room722` (ICR — Identifying Age-Related Conditions — 1st Place Solution)
...
- _works_with_ → [[concepts/knowledge-distillation|Knowledge Distillation — LGBM→NN Soft Labels, Cosine Schedules, Cross-Model Transfer]]
- _works_with_ → [[concepts/stacking-deep|Deep Stacking — Multi-Level Stacking Architectures]]

**Incoming:**
- [[concepts/tabpfn-tabm|TabPFN & TabM — New SOTA Tabular Foundation Models]] _improves_on_ → here
