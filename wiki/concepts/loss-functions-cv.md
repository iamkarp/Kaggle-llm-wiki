---
id: concept:loss-functions-cv
type: concept
title: Loss Functions for CV
slug: loss-functions-cv
aliases: []
tags:
- cv
- loss-functions
...
- _works_with_ → [[concepts/segmentation-architectures|Segmentation Architectures]]

**Incoming:**
- [[concepts/metric-learning-cv|Metric Learning for CV]] _uses_ → here
