---
id: concept:validation-strategy
type: concept
...
**Outgoing:**
- _requires_ → [[concepts/time-series-cv|Time Series Cross-Validation — Walk-Forward, Purged CV, Gap Strategy]]
...
- _cites_ → `source:memory-2026-02-22-update` (2026-02-22 (continued))
- _works_with_ → [[concepts/ensembling-strategies|Ensembling Strategies — Fourth-Root Blend, Stacking, Diversity]]
- _works_with_ → [[concepts/target-encoding|Target Encoding — Weighted Blend with OOF]]

**Incoming:**
- [[concepts/feature-selection-advanced|Advanced Feature Selection Techniques]] _uses_ → here
- [[concepts/imbalanced-data|Imbalanced Data Techniques for Kaggle]] _requires_ → here
- [[concepts/negative-downsampling|Negative Downsampling — Training on Imbalanced Data at Scale]] _requires_ → here
- [[concepts/shap-feature-engineering|SHAP as a Feature Engineering Discovery Tool]] _uses_ → here
- [[concepts/time-series-cv|Time Series Cross-Validation — Walk-Forward, Purged CV, Gap Strategy]] _requires_ → here
- [[concepts/universal-kaggle-tricks|Universal Kaggle Tricks — Cross-Competition Validated Techniques]] _requires_ → here
...
- [[concepts/nearest-neighbor-features|Nearest Neighbor Features — Non-Parametric Local Aggregation]] _works_with_ → here
...
- [[concepts/external-data-leakage|External Data Usage & Leakage Detection]] _related_to_ → here
- [[concepts/reinforcement-learning-games|Reinforcement Learning for Game AI Competitions]] _related_to_ → here
