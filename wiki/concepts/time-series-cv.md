...
**Outgoing:**
- _requires_ → [[concepts/time-series-features|Time Series Feature Engineering — Lags, Rolling Stats, Fourier]]
...
**Incoming:**
- [[concepts/time-series-features|Time Series Feature Engineering — Lags, Rolling Stats, Fourier]] _requires_ → here
- [[concepts/validation-strategy|Validation Strategy — CV Design, Gap Tracking, Anti-Patterns]] _requires_ → here
