---
id: concept:feature-engineering-tabular
type: concept
title: Feature Engineering — Tabular Data Patterns
slug: feature-engineering-tabular
aliases: []
tags:
- feature-engineering
- tabular
...
**Outgoing:**
- _uses_ → [[concepts/target-encoding|Target Encoding — Weighted Blend with OOF]]
...
- _works_with_ → [[concepts/text-feature-engineering|Text Feature Engineering — Embeddings vs TF-IDF vs Regex Extraction]]
...
**Incoming:**
- [[concepts/target-encoding|Target Encoding — Weighted Blend with OOF]] _uses_ → here
...
- [[concepts/target-encoding-advanced|Advanced Target Encoding Techniques]] _improves_on_ → here
- [[concepts/categorical-embeddings|Categorical Embeddings — Topic Models on Interaction Sequences]] _works_with_ → here
