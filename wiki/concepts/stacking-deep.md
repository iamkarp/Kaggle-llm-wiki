...
**Outgoing:**
- _cites_ → `source:amex-default-14th-chris-deotte` (American Express Default Prediction — 14th Place (Gold) Solution)
- _cites_ → `source:home-credit-1st-tunguz` (Home Credit Default Risk — 1st Place Solution)
- _cites_ → `source:moa-1st-mark-peng` (Mechanisms of Action (MoA) Prediction — 1st Place Solution)
- _cites_ → `source:otto-group-1st-giba-semenov` (Otto Group Product Classification — 1st Place Solution)
- _cites_ → `source:playground-s5e4-1st-chris-deotte` (Playground Series S5E4 — 1st Place Solution)
- _cites_ → `source:porto-seguro-1st-jahrer` (Porto Seguro Safe Driver Prediction — 1st Place Solution)
- _works_with_ → [[concepts/categorical-embeddings|Categorical Embeddings — Topic Models on Interaction Sequences]]
...
- _works_with_ → [[concepts/nearest-neighbor-features|Nearest Neighbor Features — Non-Parametric Local Aggregation]]
...
- [[concepts/multi-target-learning|Multi-Target & Auxiliary Learning]] _works_with_ → here
