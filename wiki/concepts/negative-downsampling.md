...
**Outgoing:**
- _requires_ → [[concepts/calibration|Probability Calibration — Platt Scaling and Isotonic Regression]]
- _requires_ → [[concepts/validation-strategy|Validation Strategy — CV Design, Gap Tracking, Anti-Patterns]]
- _cites_ → `source:talkingdata-fraud-1st-komaki` (TalkingData Ad Fraud Detection — 1st Place Solution)
- _works_with_ → [[concepts/pseudo-labeling|Pseudo-Labeling — Semi-Supervised Learning with High-Confidence Test Predictions]]
- _related_to_ → [[concepts/categorical-embeddings|Categorical Embeddings — Topic Models on Interaction Sequences]]

**Incoming:**
- [[concepts/imbalanced-data|Imbalanced Data Techniques for Kaggle]] _uses_ → here
