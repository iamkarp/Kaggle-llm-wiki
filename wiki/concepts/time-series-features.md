---
id: concept:time-series-features
type: concept
...
- _cites_ → `source:m5-forecasting-1st-yeonjun` (M5 Forecasting — 1st Place Solution)
...
- _cites_ → `source:timeseries-nlp-techniques` (Kaggle Time Series Forecasting & NLP/LLM Techniques (2022–2025))
...
**Incoming:**
- [[concepts/financial-competition-patterns|Financial & Trading Competition Patterns]] _uses_ → here
