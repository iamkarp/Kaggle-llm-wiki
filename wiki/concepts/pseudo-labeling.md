...
- _cites_ → `source:santander-transaction-1st-fl2o` (Santander Customer Transaction Prediction — 1st Place Solution)
...
**Incoming:**
- [[concepts/universal-kaggle-tricks|Universal Kaggle Tricks — Cross-Competition Validated Techniques]] _uses_ → here
- [[concepts/pseudo-labeling-cv|Pseudo-Labeling for CV]] _improves_on_ → here
...
- [[concepts/negative-downsampling|Negative Downsampling — Training on Imbalanced Data at Scale]] _works_with_ → here
- [[concepts/pseudo-labeling-cv|Pseudo-Labeling for CV]] _works_with_ → here
- [[concepts/synthetic-data-distillation|Synthetic Data Distillation — Teacher→Student for Kaggle]] _works_with_ → here
