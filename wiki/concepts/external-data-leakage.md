---
id: concept:external-data-leakage
type: concept
title: External Data Usage & Leakage Detection
slug: external-data-leakage
aliases: []
tags:
- leakage
- external-data
...
**Outgoing:**
- _works_with_ → [[concepts/feature-selection-advanced|Advanced Feature Selection Techniques]]
- _works_with_ → [[concepts/imbalanced-data|Imbalanced Data Techniques for Kaggle]]
