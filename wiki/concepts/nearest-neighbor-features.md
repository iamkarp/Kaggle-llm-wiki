---
id: concept:nearest-neighbor-features
type: concept
title: Nearest Neighbor Features — Non-Parametric Local Aggregation
slug: nearest-neighbor-features
aliases: []
tags:
- nearest-neighbor
- knn
...
- _cites_ → `source:optiver-volatility-1st-nyanp` (Optiver Realized Volatility Prediction — 1st Place Solution)
